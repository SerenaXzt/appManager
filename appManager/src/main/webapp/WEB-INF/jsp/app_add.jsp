				...
				<div class="left_col scroll-view">
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3>${sessionScope.userSession.devcode }</h3>
				...
				<div class="nav_menu">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class=""><a href="javascript:;"
							...
							aria-expanded="false"> <img src="images/img.jpg" alt="">${sessionScope.userSession.devname }<span 
        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>新增APP基础信息 <small>${sessionScope.userSession.devname }</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea class="form-control" rows="3" placeholder='rows="3"' placeholder="请输入本软件的相关信息，本信息作为软件的详细信息进行软件的介绍"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
